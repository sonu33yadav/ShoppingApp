...
include "./common.php";
$log = new KLogger("./log_02/", KLogger::DEBUG);
$paymentData = getPaymentsDataFor2Percent();
if (false == $paymentData) {
    $log->LogInfo("[PAYMENT 02], No payments found for notification");
    exit();
}
foreach ($paymentData as $payment) {
    ...
    if (1 == $smsAlert && 1 == $emailAlert && 1 == $voiceAlert) {
        ...
        $msg = "You have 2% of your $bundle bundle remaining. Kindly click the link to recharge https://txtconnect.net/cms/plans";
        //Send Alert On SMS
        $log->LogInfo("[PAYMENT 02], Payment ID [$id],  Bundle [$bundle], Text [$msg], Notification sent");
        sendSMS($msisdn, $msg);
        $subject = "Recharge reminder";
        $content = "Hi $userName<BR><BR>You have 2% of your $bundle bundle remaining. Kindly click the link to recharge https://txtconnect.net/cms/plans<BR><BR>Thanks,<BR>Team TxtConnect<BR>https://txtconnect.net";
        //Send Alert On Email
